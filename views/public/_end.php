  ...
  <footer class="site-footer">
    <div class="container footer-grid">
      <div class="footer-brand">
        ...
        <?php $ct = $ct ?? Settings::contact(); ?>
        <?php if ($ct['head_office'] !== ''): ?><p style="margin-top:12px"><?= Html::e($ct['head_office']) ?></p><?php endif; ?>
        <p><a href="tel:+<?= Html::e($ct['phone1tel']) ?>"><?= Html::e($ct['phone1']) ?></a> · <a href="mailto:<?= Html::e($ct['email']) ?>"><?= Html::e($ct['email']) ?></a></p>
        <div class="socials">
      ...
      <div>
        <h2>Quick links</h2>
        <ul>
          <?php foreach ($footerMenu ?? [] as $f): if (!empty($f['parent_id'])) { continue; } ?>
  ...
  <div class="float-contact">
    ...
    <a class="mail" href="mailto:<?= Html::e(($ct ?? Settings::contact())['email']) ?>" aria-label="Email"><svg viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg></a>
  </div>
