        ...
        <div class="blog-post-layout">
          <div class="blog-post-main min-w-0">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <img src="<?php echo esc_url(vr_media_url($img)); ?>" alt="<?php echo esc_attr($post['title'] ?? ''); ?>" class="w-full object-cover max-h-[420px]" decoding="async" loading="lazy"<?php $__ss = vr_srcset($img); if ($__ss !== '') : ?> srcset="<?php echo esc_attr($__ss); ?>" sizes="(max-width: 768px) 100vw, 50vw"<?php endif; ?>>
          ...
          ?>
            <a href="<?php echo esc_url(home_url('/blog/' . $r['slug'] . '/')); ?>" class="group bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-md hover:border-orange-200 transition">
              <div class="aspect-[16/10] overflow-hidden">
                <img src="<?php echo esc_url(vr_media_url($rImg)); ?>" alt="<?php echo esc_attr($r['title']); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" decoding="async"<?php $__ss = vr_srcset($rImg); if ($__ss !== '') : ?> srcset="<?php echo esc_attr($__ss); ?>" sizes="(max-width: 768px) 100vw, 50vw"<?php endif; ?>>
              </div>
              <div class="p-5">
