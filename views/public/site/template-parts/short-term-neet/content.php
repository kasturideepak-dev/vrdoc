<?php
/**
 * Short-Term NEET Program page content
 *
 * @package VR_Doctors
 */

vr_neet_set_context('short-term-neet-program-hyderabad');
...
vr_neet_set_context('short-term-neet-program-hyderabad', 'skill_tests', 'bg-white');
get_template_part('template-parts/neet-landing/bullet-section');

vr_neet_set_context('short-term-neet-program-hyderabad', 'regulations', 'bg-blue-50');
get_template_part('template-parts/neet-landing/bullet-section');

vr_neet_set_context('short-term-neet-program-hyderabad', 'residential', 'bg-white');
get_template_part('template-parts/neet-landing/bullet-section');
